...
def get_args(phase):
    ...
    if phase == 'train':
        ...
        parser.add_argument('--is_modelarts', type=ast.literal_eval, default=False, help='Default not train in Modelarts.')
        ...
        parser.add_argument('--noBN', type=ast.literal_eval, default=False, help='use batchnorm or not (only for DCGAN)')
        parser.add_argument('--mlp_G', type=ast.literal_eval, default=False, help='use MLP for G')
        parser.add_argument('--mlp_D', type=ast.literal_eval, default=False, help='use MLP for D')
